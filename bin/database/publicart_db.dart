...
class NewsPapers extends Table {
  ...
  //eternal link
  TextColumn get eternalLink => text()();
  //event dates
...
@DataClassName('NewsPaperTag')
class NewsPaperTags extends Table {
  @override
  Set<Column> get primaryKey => {newsPaperId, tagId};
  TextColumn get newsPaperId => text()();
  IntColumn get tagId => integer()();
}

@DataClassName('NewsPaperLink')
class NewsPaperLinks extends Table {
  @override
  Set<Column> get primaryKey => {newsPaperId, linkId};
  TextColumn get newsPaperId => text()();
  TextColumn get linkId => text()();
}
...
@DataClassName('NewsPaperVideo')
class NewsPaperVideos extends Table {
  @override
  Set<Column> get primaryKey => {newsPaperId, videoId};
  TextColumn get newsPaperId => text()();
...
class PublicArtDB extends _$PublicArtDB {
  ...
  //news tags
  Stream<List<NewsPaperTag>> get watchAllNewsPaperTags => select(newsPaperTags).watch();
  Future<List<NewsPaperTag>> get getAllNewsPaperTags => select(newsPaperTags).get();
  Future<List<NewsPaperTag>> getNewsPaperTagsById(String id) => (select(newsPaperTags)..where((a) => a.newsPaperId.equals(id))).get();
  Future<NewsPaperTag> getNewsPaperTagById(String newsId) => (select(newsPaperTags)..where((a) => a.newsPaperId.equals(newsId))).getSingle();
  Future insertNewsPaperTag(NewsPaperTag newsPaperTag)=> into(newsPaperTags).insert(newsPaperTag);
  Future updateNewsPaperTag(NewsPaperTag newsPaperTag)=> update(newsPaperTags).replace(newsPaperTag);
  Future deleteNewsPaperTag(NewsPaperTag newsPaperTag)=> delete(newsPaperTags).delete(newsPaperTag);
  //news links
  Stream<List<NewsPaperLink>> get watchAllNewsPaperLinks => select(newsPaperLinks).watch();
  Future<List<NewsPaperLink>> get getAllNewsPaperLinks => select(newsPaperLinks).get();
  Future<List<NewsPaperLink>> getNewsPaperLinksById(String newsId) => (select(newsPaperLinks)..where((a) => a.newsPaperId.equals(newsId))).get();
  Future<NewsPaperLink> getNewsPaperLinkById(String newsId) => (select(newsPaperLinks)..where((a) => a.newsPaperId.equals(newsId))).getSingle();
  Future insertNewsPaperLink(NewsPaperLink newsPaperLink)=> into(newsPaperLinks).insert(newsPaperLink);
  Future updateNewsPaperLink(NewsPaperLink newsPaperLink)=> update(newsPaperLinks).replace(newsPaperLink);
  Future deleteNewsPaperLink(NewsPaperLink newsPaperLink)=> delete(newsPaperLinks).delete(newsPaperLink);
  //news images
  ...
  Future<List<NewsPaperImage>> getNewsPaperImagesById(String id) => (select(newsPaperImages)..where((a) => a.newsPaperId.equals(id))).get();
  ...
  //news videos
  Stream<List<NewsPaperVideo>> get watchAllNewsPaperVideos => select(newsPaperVideos).watch();
  Future<List<NewsPaperVideo>> get getAllNewsPaperVideos => select(newsPaperVideos).get();
  Future<NewsPaperVideo> getNewsPaperVideoById(String newsId) => (select(newsPaperVideos)..where((a) => a.newsPaperId.equals(newsId))).getSingle();
  Future insertNewsPaperVideo(NewsPaperVideo newsPaperVideo)=> into(newsPaperVideos).insert(newsPaperVideo);
  Future updateNewsPaperVideo(NewsPaperVideo newsPaperVideo)=> update(newsPaperVideos).replace(newsPaperVideo);
  Future deleteNewsPaperVideo(NewsPaperVideo newsPaperVideo)=> delete(newsPaperVideos).delete(newsPaperVideo);
  //news addresses
  ...
  ///VIDEO CRUD
  Stream<List<Video>> get watchAllVideos => select(videos).watch();
  Future<List<Video>> get getAllVideos => select(videos).get();
  Future<Video> getVideoById(String id) => (select(videos)..where((video) => video.id.equals(id))).getSingle();
  Future insertVideo(Video video)=> into(videos).insert(video);
  Future updateVideo(Video video)=> update(videos).replace(video);
  Future deleteVideo(Video video)=> delete(videos).delete(video);
